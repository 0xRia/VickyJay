  ...
  return (
    <section className="mx-[30px] mt-[60px] lg:mx-[76px] lg:mt-[150px]">
      <div className="flex flex-col items-center gap-[35px] md:gap-[25px]">
        <h3
          className={`font-medium text-[#FFFFFF] text-lg text-center max-w-[320px] md:max-w-[992px] md:text-[25px] mmd:leading-[37.5px]`}
        >
          I can help you structure, improve or build the backend and security experience to secure your asset or data for
        ...
        <p className="flex items-center font-semibold text-[15px] leading-[22.5px] md:text-[20px] md:leading-[30px] text-[#FFFFFF]">
      ...
      >
        <div className="flex flex-col items-center gap-[10px]">
          <div className="bg-gradient-to-l from-[#000080] to-[#00008000] pr-[1px] pt-[1px] max-w-[75px] max-h-[75px]">
            <MailIcon
              className={`w-[30px] h-[30px] p-2 md:p-[5px] bg-[#000080] md:w-[36px] md:h-[36px]`}
            />
          </div>
          <a
            className={`text-[#FFFFFF] font-medium text-base md:text-[20px] md:leading-[30px]`}
            href="mailto:gloria.u.samuel@gmail.com"
          >
            gloria.u.samuel@gmail.com
          </a>
        </div>
